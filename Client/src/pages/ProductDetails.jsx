...
export default function ProductDetails() {
  ...
  const handleLike = async () => {
    console.log("Name", currentUser?.access_token);
    console.log("Time", state?.product._id);
    try {
      await likeProduct(
        state?.product._id,
      ...
      toast.error("Unable to like product, please login first");
    }
  };
        ...
        {loading ? (
          ...
          <div className="position-relative">
           <BsArrowLeftCircle
            ...
            <div
              className="d-flex gap-4 overflow-x-auto overflow-x-hidden h-100"
              ref={scrollRef}
            >
